...
<div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <h4>หัวหน้าหน่วยบริการหอพักนักศึกษา</h4>
      </div>
    ...
    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
      <li class="nav-header"></li>
          ...
          <li class="nav-item">
                  <a href="/Head_Dormitory_Service/showDataActivity" class="nav-link">
          ...
          <li class="nav-item">
                  <a href="/Head_Dormitory_Service/manageActivity" class="nav-link">
